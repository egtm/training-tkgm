...
- [Set Airgap Registry](#set-airgap-registry)
...
tanzu config set env.TANZU_CLI_RECOMMEND_VERSION_DELAY_DAYS 0
tanzu init
...
# Set Airgap Registry
- To accelarate the cluster deployment, use internal registry
```bash
